...
<script type='text/javascript'>
	...
	showChart = function(type){
		...
		if(type=='day'){
			$.ajax({
				url:"heartRate/" + <%=deviceId%> + "/getHeartRate?duration=1&startTime=" + $("#startTime1").val() + 
			...
			$.ajax({
				url:"heartRate/" + <%=deviceId%> + "/getHeartRate?duration=2&startTime=" + $("#startTime2").val() + 
			...
			$.ajax({
				url:"heartRate/" + <%=deviceId%> + "/getHeartRate?duration=2&startTime=" + $("#startTime3").val() + 
