   ...
   <form class="form-x" onsubmit="return onSubmit();"> 
       ...
       <div class="form-group">
           ...
           <div class="field" style="width:15%;">
               <input type="text" class="input" id="braceletInterval" name="braceletInterval" size="50" data-validate="required:请填写数据采集间隔,number:格式错误(数字)" />
           </div>  
       ...
       <div class="form-group">
           ...
           <div class="field" style="width:15%;">
               <input type="text" class="input" id="braceletUpload" name="braceletUpload" size="50"  data-validate="required:请填写上传数据条数,number:格式错误(数字)" />
           </div>
