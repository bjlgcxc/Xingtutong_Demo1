...
<script type='text/javascript'>
	...
	showChart = function(type){
		...
		if(type=='day'){
			$.ajax({
				url:"environment/" + <%=deviceId%> + "/getHumidity?duration=1&startTime=" + $("#startTime1").val() + 
			...
			$.ajax({
				url:"environment/" + <%=deviceId%> + "/getHumidity?duration=2&startTime=" + $("#startTime2").val() + 
			...
			$.ajax({
				url:"environment/" + <%=deviceId%> + "/getHumidity?duration=2&startTime=" + $("#startTime3").val() + 
