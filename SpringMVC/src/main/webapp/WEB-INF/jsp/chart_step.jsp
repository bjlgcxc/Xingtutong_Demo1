...
<script>
	...
	function toDayView(startTime,endTime){
		 $("#change").text('>>多日数据视图');
		 $.ajax({
	     	url:"sport/" + <%=deviceId%> + "/getStepInfo?duration=1&startTime=" + startTime + "&endTime="+endTime,
	     	type:"get",
			dataType:'json',
	...
	function toDaysView(startTime,endTime){
		$("#change").text('>>单日数据视图');
		$.ajax({
	     	url:"sport/" + <%=deviceId%> + "/getStepInfo?duration=2&startTime=" + startTime + "&endTime="+endTime,
	     	type:"get",
			dataType:'json',
			contentType: 'application/json;charset=utf-8',
			success:function(data){ 
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="font-size:16px">
						<div>DeviceID：<%=deviceId%>&nbsp;&nbsp;&nbsp;&nbsp;Type：<%=pageInfo%></div><br/>
						...
						<div style="float:right"><a id="change" href="#"></a></div>
					</div>
